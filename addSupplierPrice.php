<?php
    ...
    $date = $reg = $mid = $prem = "";
    $date_err = $reg_err = $mid_err = $prem_err = "";
    $success_msg = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$hasError) {
                ...
                $sql = "INSERT INTO dailysupplierprice (Date, Regular, MidGrade, Premium) 
                    VALUES ('$date', '$regular', '$midgrade', '$premium') ";
...
<head>
    ...
    <title>GCG - Add Supplier Price</title>
		...
		<div class="w3-container w3-center">
			<div class="w3-card-4" style="width:100%">
				<div class="w3-container w3-center w3-theme-d3">
					<h4>Add Daily Supplier Price</h4>
				</div>
			</div>
		</div>

		<form action="addSupplierPrice.php" method="POST" class="w3-margin">
